      ...
      <section className="relative pt-20 px-6 z-10">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="flex flex-col md:flex-row justify-between items-center mb-16 gap-8 border-b border-[#1a1a1a] pb-12">
            ...
            {/* Pulsing Playlist Icon (The Side Part) */}
            <a 
              href="https://open.spotify.com/playlist/2st5Wtynvwlonzysk7CAeT" 
              target="_blank" 
              rel="noopener noreferrer"
              className="group relative flex items-center justify-center w-24 h-24 bg-[#1DB954] rounded-full hover:scale-110 transition-all duration-500 shadow-[0_0_40px_rgba(29,185,84,0.3)]"
            >
          ...
          {/* Song Grid: 2 per line, 5th centered */}
            ...
            {tracks.map((track, i) => (
              ...
              >
                <div className="flex justify-between items-center mb-6">
                  ...
                  <span className="text-[10px] bg-[#9c27b0] text-white px-2 py-1 rounded font-bold opacity-0 group-hover:opacity-100 transition-all duration-500">
                    NOW PLAYING
                  </span>
                </div>
